...
// rhode: manager v3.4.0 wymaga dokładnie 4 (inaczej baner "wymagana aktualizacja jądra").
// Z 3 przeniesiono poprawkę file_wrapper; fd sesji su nie jest instalowany (ksud 3.4.0
// wraca wtedy do zwykłego [ksu_driver]) - dotyczy tylko własnych, ograniczonych profili roota.
